...
module SwaggerClient
  class DefaultApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :access_type Access Type (access_key/saml/ldap/azure_ad/aws_iam)
    ...
    # @return [ReplyObj]
    def auth(access_id, opts = {})
      data, _status_code, _headers = auth_with_http_info(access_id, opts)
      data
    end
    ...
    # @option opts [String] :ldap_proxy_url Address URL for LDAP proxy (relevant only for access-type&#x3D;ldap)
    # @return [Array<(ReplyObj, Fixnum, Hash)>] ReplyObj data, response status code and response headers
    def auth_with_http_info(access_id, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && access_id.nil?
        fail ArgumentError, "Missing the required parameter 'access_id' when calling DefaultApi.auth"
      end
      # resource path
      local_var_path = '/auth'
      ...
      # query parameters
      query_params = {}
      query_params[:'access-id'] = access_id
    ...
    # @option opts [String] :access_type Access Type (access_key/azure_ad/saml/ldap/aws_iam)
    # @option opts [String] :ldap_proxy_url Address URL for ldap proxy (relevant only for access-type&#x3D;ldap)
    # @option opts [String] :azure_ad_object_id Azure Active Directory ObjectId (relevant only for access-type&#x3D;azure_ad)
    # @return [ReplyObj]
    def configure(access_id, opts = {})
      data, _status_code, _headers = configure_with_http_info(access_id, opts)
      data
    end
    ...
    # @option opts [String] :azure_ad_object_id Azure Active Directory ObjectId (relevant only for access-type&#x3D;azure_ad)
    # @return [Array<(ReplyObj, Fixnum, Hash)>] ReplyObj data, response status code and response headers
    def configure_with_http_info(access_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DefaultApi.configure ...'
      end
      # verify the required parameter 'access_id' is set
      if @api_client.config.client_side_validation && access_id.nil?
        fail ArgumentError, "Missing the required parameter 'access_id' when calling DefaultApi.configure"
      end
      # resource path
